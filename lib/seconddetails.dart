// ignore_for_file: unused_import, must_be_immutable, use_key_in_widget_constructors, prefer_typing_uninitialized_variables, unused_local_variable, avoid_unnecessary_containers, prefer_const_constructors
            ...
            child: SingleChildScrollView(
              ...
              child: Container(
                  decoration: BoxDecoration(
                      color: Colors.white,
                      border: Border.all(
                          color: const Color(0xFFD50000), width: 10)),
                  child: Padding(
